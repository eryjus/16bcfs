//===================================================================================================================
//  hw-bus-16.cc -- This is a generic bus
//
...
//
// -- Maintain the bits on the 16-bit bus
//    -----------------------------------
void HW_Bus_16_t::MaintainBit(int bit, TriState_t state)
{
...
//    ------------------------------------------------------------------------------------------
void HW_Bus_16_t::ProcessSanityCheck(void)
{
