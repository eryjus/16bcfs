...
void AluFlagsModule_t::WireUp(void)
{
    ...
    connect(and1, &IC_74xx08_t::SignalY1Updated, zcLatch, &IC_74xx74_t::ProcessUpdateClk1);
    ...
    connect(and1, &IC_74xx08_t::SignalY2Updated, zcLatch, &IC_74xx74_t::ProcessUpdateClk2);
    ...
    connect(and1, &IC_74xx08_t::SignalY3Updated, nvLatch, &IC_74xx74_t::ProcessUpdateClk2);
    ...
    connect(and1, &IC_74xx08_t::SignalY3Updated, lLatch, &IC_74xx74_t::ProcessUpdateClk1);
